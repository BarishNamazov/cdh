...
Review changes in the working directory. You are a code reviewer. CDH workflow context is provided.
...
5. Record a decision with your verdict using `record_decision`.
