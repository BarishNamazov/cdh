...
This says that the state includes a set of users and associates with each user a username and a password, each of which is a string. State declarations use **Simple State Form (SSF)** — see `detailed/concept-state.md` for the full grammar.
